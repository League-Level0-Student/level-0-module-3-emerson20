 ...
 * Anynumber divisible by 5 is replaced by the word buzz. Numbers divisible by
 * both 3 and 5 become fizzbuzz. Print your results to the console, or using
 * JOptionPane if you like.
 * 
...
public class FizzBuzz {
	public static void main(String[] args) {
		JOptionPane.showMessageDialog(null,
				"Welcome to fizzbuzz! Here are the rules:" + "Any number divisible by 3 is replaced by the word fizz \n"
						+ "Any number divisible by 5 is replaced by the word buzz. \n"
						+ "Numbers divisible by both 3 and 5 become fizzbuzz.\n ");
		String reeds = JOptionPane.showInputDialog("Ready? Begin!");
